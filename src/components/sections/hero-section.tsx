...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[85vh] sm:min-h-[80vh] w-full flex items-start sm:items-center justify-center overflow-hidden bg-white pt-[8.5rem] sm:pt-4 md:pt-24">
