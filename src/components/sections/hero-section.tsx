...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[50vh] sm:min-h-[80vh] md:min-h-[75vh] w-full flex items-start sm:items-center justify-center overflow-hidden bg-white pt-24 sm:pt-4 md:pt-24">
