...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[85vh] sm:min-h-[80vh] w-full flex items-start sm:items-center justify-center overflow-hidden bg-white pt-[8.5rem] sm:pt-4 md:pt-24 pb-8 sm:pb-0">
...
export default function HeroSection() {
    return (
        <>
            <AnimatedNavFramer />
            <div className="flex flex-col text-center items-center justify-center -space-y-16 sm:space-y-0">
                <HeroGeometric
                    title1="Put Everything on Autopilot — Save Hours and Eliminate Extra Hires"
                    title2="" />
                <StatsSection />
