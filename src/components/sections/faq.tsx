...
const faqs = [
  {
    ...
    answer:
      "Launch tier takes 2-3 weeks, Scaling takes about 4-6 weeks, for Enterprises a custom timeline is required.",
    meta: "Setup",
  },
  {
    question: "Do your systems handle and align with compliances?",
    answer:
      "Yes, we align to your policies and can implement SOC2-ready processe that are GDPR compliant as well as comply with all policies.",
    meta: "Features",
  },
  {
    question: "What industries benefit from AI automation?",
    answer:
      "Any business. Including home services, solar, real estate, healthcare, marketing agencies and 100+ niches. AI automation adoption is growing quickly across all industries.",
    meta: "Industries",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We build custom workflows, integrations, and automation sequences to match your specific business needs and brand.",
    meta: "Custom",
  },
];
...
const palette = {
  ...
  heading: "text-black",
  muted: "text-black",
  iconRing: "border-orange-300",
  iconSurface: "bg-orange-900/5",
  icon: "text-orange-900",
  glow: "rgba(255, 154, 0, 0.08)",
  aurora: "",
  shadow: "shadow-[0_36px_120px_-70px_rgba(255,154,0,0.18)]",
  overlay: "",
};
...
function FAQ1() {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .faq1-intro__beam {
        background: conic-gradient(from 180deg, rgba(255, 154, 0, 0.3), transparent 30%, rgba(255, 154, 0, 0.25) 58%, transparent 80%, rgba(255, 154, 0, 0.2));
    ...
    <div className={`relative min-h-screen w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}>
      ...
      >
        ...
        >
          ...
          <span className="faq1-intro__label">Frequently Asked</span>
